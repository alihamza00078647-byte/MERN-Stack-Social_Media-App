...
export function Navbar() {
  ...
  return (
    <nav className="bg-black w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 py-1 md:py-2">
      {/* Logo */}
      ...
      <div className="hidden md:flex items-center gap-4">
        ...
        <button className="px-8 py-2.5 rounded-full ml-4 bg-white text-black transition-all duration-500">
          Login
        </button>
      </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 left-0 w-full h-screen bg-white text-base flex flex-col md:hidden items-center justify-center gap-6 font-medium text-black transition-all duration-500 ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <button
